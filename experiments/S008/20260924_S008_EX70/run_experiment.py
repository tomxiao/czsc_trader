...
def main() -> None:
    ...
    context = create_experiment_context(
        ...
        dataflows=dataflows,
        workspace=workspace,
        resources=ExperimentResources(max_workers=1, random_seed=2026097001),
    ...
    build_experiment_manifest(
        experiment_root,
        {
            ...
            "technical_predecessor_experiment_id": "20260924_S008_EX69",
            "evidence_predecessor_experiment_id": predecessor.experiment_id,
