...
def main() -> None:
    ...
    context = create_experiment_context(
        ...
        dataflows=Dataflows(),
        workspace=workspace,
        resources=ExperimentResources(max_workers=1, random_seed=20260902),
        real_returns=False,
    )
    ...
    (experiment_root / "03_execution.md").write_text(
        "# S009 EX02 执行\n\n"
        f"REX receipt={result.receipt.sha256}。EX01冻结源码与失败manifest通过身份门；七项DFLS请求通过。"
    ...
    build_experiment_manifest(experiment_root, {
        ...
        "technical_predecessor_experiment_id": "20260925_S009_EX01",
